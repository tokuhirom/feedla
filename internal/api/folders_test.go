...
func TestFoldersListAndCreate(t *testing.T) {
	...
	resp, err := http.Get(apiSrv.URL + "/api/v1/folders")
	if err != nil {
	...
	resp = postJSON(t, apiSrv.URL+"/api/v1/folders", map[string]string{"name": "Tech"})
...
func TestCreateFolderMissingName(t *testing.T) {
	...
	resp := postJSON(t, apiSrv.URL+"/api/v1/folders", map[string]string{"name": "  "})
